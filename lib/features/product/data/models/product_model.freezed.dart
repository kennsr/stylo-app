...
@override
String toString() {
  return 'ProductModel(id: $id, name: $name, description: $description, price: $price, discountPrice: $discountPrice, category: $category, images: $images, variants: $variants, rating: $rating, reviewCount: $reviewCount, stock: $stock, isFeatured: $isFeatured, hasAiTryOn: $hasAiTryOn)';
}
...
@useResult
$Res call({
 String id, String name, String description, double price,@JsonKey(name: 'discount_price') double? discountPrice, String category, List<String> images, List<ProductVariantModel> variants, double rating,@JsonKey(name: 'review_count') int reviewCount, int stock,@JsonKey(name: 'is_featured') bool isFeatured,@JsonKey(name: 'has_ai_try_on') bool hasAiTryOn
});
...
as List<ProductVariantModel>,rating: null == rating ? _self.rating : rating // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description,  double price, @JsonKey(name: 'discount_price')  double? discountPrice,  String category,  List<String> images,  List<ProductVariantModel> variants,  double rating, @JsonKey(name: 'review_count')  int reviewCount,  int stock, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'has_ai_try_on')  bool hasAiTryOn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String description,  double price, @JsonKey(name: 'discount_price')  double? discountPrice,  String category,  List<String> images,  List<ProductVariantModel> variants,  double rating, @JsonKey(name: 'review_count')  int reviewCount,  int stock, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'has_ai_try_on')  bool hasAiTryOn)  $default,) {final _that = this;
switch (_that) {
case _ProductModel():
return $default(_that.id,_that.name,_that.description,_that.price,_that.discountPrice,_that.category,_that.images,_that.variants,_that.rating,_that.reviewCount,_that.stock,_that.isFeatured,_that.hasAiTryOn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String description,  double price, @JsonKey(name: 'discount_price')  double? discountPrice,  String category,  List<String> images,  List<ProductVariantModel> variants,  double rating, @JsonKey(name: 'review_count')  int reviewCount,  int stock, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'has_ai_try_on')  bool hasAiTryOn)?  $default,) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.price,_that.discountPrice,_that.category,_that.images,_that.variants,_that.rating,_that.reviewCount,_that.stock,_that.isFeatured,_that.hasAiTryOn);case _:
  return null;
